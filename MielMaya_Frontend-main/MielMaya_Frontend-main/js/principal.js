...
// Clase UserSidebar para manejar el sidebar de usuario en index.html
class UserSidebar {
    constructor() {
        this.init();
        this.loadUserData();
    ...
    async loadUserData() {
        ...
        if (userData) {
            ...
            if (userName) {
                userName.textContent = (userData.nombre || userData.Nombre_Completo || 'Usuario').toUpperCase();
            }
        }
    }
...
document.addEventListener('DOMContentLoaded', async () => {
    // Inicializar UserSidebar SIEMPRE (para usuarios autenticados y no autenticados)
