...
class ReviewService {
    ...
    async deleteReview(reviewId) {
        try {
            const response = await APIClient.delete(`/api/comments/${reviewId}`);
            ...
            for (const product of products) {
                try {
                    ...
                    if (reviewsResponse.success && Array.isArray(reviewsResponse.data)) {
                        ...
                        allReviews.push(...reviewsResponse.data);
                    }
                } catch (e) {
                    console.warn('Error agregando reseñas del producto', product, e);
                }
            }
